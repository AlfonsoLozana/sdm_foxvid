...
public class PostsTest {
    ...
    public void postsTest() {
        ...
        ViewInteraction linearLayout = onView(
                allOf(withParent(withParent(IsInstanceOf.<View>instanceOf(androidx.cardview.widget.CardView.class))),
                        isDisplayed()));
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.txtNewPost),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("Prueba de esprrsso"), closeSoftKeyboard());

        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.txtNewPost), withText("Prueba de esprrsso"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("androidx.coordinatorlayout.widget.CoordinatorLayout")),
                                        1),
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.txtNewPost), withText("Prueba de esprrsso"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("Prueba de espresso"));

        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.txtNewPost), withText("Prueba de espresso"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("androidx.coordinatorlayout.widget.CoordinatorLayout")),
                                        1),
        ...
        ViewInteraction textView3 = onView(
                allOf(withId(R.id.txtPost), withText("ahora voy hacer que te lleve a ajustes para activas la ubicación"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class))),
                        isDisplayed()));
        textView3.check(matches(withText("ahora voy hacer que te lleve a ajustes para activas la ubicación")));
        ...
        ViewInteraction cardView = onView(
                allOf(withParent(allOf(withId(R.id.idRvPost),
